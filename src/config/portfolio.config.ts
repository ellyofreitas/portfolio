...
export const portfolioConfig = {
  ...
  description:
    'I am a Passionate Solutions Architect & Software Engineer with 5+ years of experience, specializing in backend development, software architecture, and cloud infrastructure.',
